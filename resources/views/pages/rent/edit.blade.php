        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Car Rents</div>
                </div>
            </div>

            <div class="section-body">
                <h2 class="section-title">Car Rents</h2>



                <div class="card">
                    <form action="{{ route('rent.update', $rent) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    name="date_start" value="{{ $rent->date_start }}">
                                @error('date_start')
                            ...
                            <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    name="date_end" value="{{ $rent->date_end }}">
                                @error('date_end')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <select class="form-control selectric @error('car_data_id') is-invalid @enderror"
                                    ...
                                    @foreach ($carDatas as $carData)
                                        <option value="{{ $carData->id }}"
                                            {{ $rent->car_data_id == $carData->id ? 'selected' : '' }}>
